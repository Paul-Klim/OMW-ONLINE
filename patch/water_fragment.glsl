...
const float VISIBILITY = 400.000;
...
const float WAVE_SCALE = 360.0;                     // overall wave scale

const float BUMP = 0.37;                            // overall water surface bumpiness
...
const vec3 SUN_EXT = vec3(0.21, 0.35, 0.32);       //sunlight extinction
...
const vec3 WATER_COLOR = vec3(0.10195, 0.215685, 0.22745);
